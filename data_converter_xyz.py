...
from radar_detections import RadarEmulator, h_inv_torch
from datetime import datetime
from stonesoup.types.groundtruth import GroundTruthPath, GroundTruthState

"""
Unlike data_converter.py, this file converts measurements to px,py,pz and saves those. 
This is done to test AI algorithms to see if they perform better when actual positions are given rather than
expecting them to learn conversion between azimuth, elevation, range and px,py,pz
"""

m = 6 # State dimension: [px, vx, py, vy, pz, vz]
n = 3 # Observation dimension: [px, py, pz]
...
def get_measurements(radar, path):
    ...
    for meas in sorted_measurements:
        ...
        # m_states.append(v)
        state_6d = h_inv_torch(v)
        xyz = state_6d[[0, 2, 4]].view(-1)
        m_states.append(xyz)
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = r'C:\Users\Admin\projects\radartracking\dataset\torch_data_xyz.pt'
